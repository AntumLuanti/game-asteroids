...
# Asteroids Game for Luanti Licensing
...
- [menu theme](menu/theme.ogg) &amp; [asteroids_hit](mods/asteroids/sounds/)
    - [CC0]
    - author: ColinSc
    - [link](https://freesound.org/s/546762/)
- [asteroids_ship_engine](mods/ship/sounds/asteroids_ship_engine.ogg)
    - [CC0]
    - author: theMinesAreShakin
    - [link](https://opengameart.org/node/170392)
- [asteroids_ship_explosion](mods/ship/sounds/asteroids_ship_explosion.ogg)
    - [CC0]
    - author: Rick Hoppmann (TinyWorlds)
    - [link](https://opengameart.org/node/33778)
- [asteroids_ship_shoot](mods/ship/sounds/asteroids_ship_shoot.ogg)
    - [CC BY 3.0]
    - author: dklon
    - [link](https://opengameart.org/node/6882)
- [asteroids_heartbeat](mods/asteroids/sounds/asteroids_heartbeat_60bpm.ogg)
    - [CC0]
